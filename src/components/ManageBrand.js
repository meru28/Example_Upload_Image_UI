...
class ManageBrand extends Component {
    ...
    componentDidMount() {
        axios.get('https://api-mysql-meru.herokuapp.com/brand/getlistbrand')
        .then((res) => {
    ...
    onBtnAddClick = () => {
        if(document.getElementById("AddBrandImage").files[0] !== undefined) {
            ...
            axios.post("https://api-mysql-meru.herokuapp.com/brand/addbrand", formData, headers)
            .then((res) => {
    ...
    onBtnDeleteClick = (id) => {
        if(window.confirm('Are you sure to delete?')) {
            axios.delete('https://api-mysql-meru.herokuapp.com/brand/deletebrand/' + id)
            .then((res) => {
    ...
    onBtnUpdateClick = (id) => {
        ...
        axios.put("https://api-mysql-meru.herokuapp.com/brand/editbrand/" + id, formData, headers)
        .then((res) => {
